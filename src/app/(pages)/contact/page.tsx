  ...
  return (
    <div className="container mx-auto px-4">
      <div className="max-w-6xl">
        <Header backdrop={t('contact.backdrop')} title={t('contact.getInTouch') } />

        <div className="flex gap-8 items-start">
          {/* Left Section - Contact Info */}
          <div className="flex-1/3 space-y-8">
            <div>
              <h3 className="text-xl font-bold text-white mb-4">{t('contact.dontBeShy')}</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">nam23062002@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">+84 914 837 433</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg viewBox="0 0 320 512" fill="currentColor" className="h-8 w-8 text-white">
          ...
          <div className="flex-2/3 p-4">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                {formErrors.message[0] && (
                  <p className="mt-1 text-sm text-red-500">{formErrors.message[0]}</p>
                )}
              </div>
              ...
              <div className="flex justify-center">
                ...
                >
                  <span className={`truncate transition-all duration-300 ${isSubmitting ? 'opacity-0' : 'opacity-100'}`}>
