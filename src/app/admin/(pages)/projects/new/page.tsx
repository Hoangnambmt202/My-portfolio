        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between py-4 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="flex items-center gap-2 px-5 py-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-lg shadow-lg shadow-blue-900/20 transition-all active:scale-95">
                <Save size={18} />
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="flex items-center gap-1.5 px-3 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium rounded-full transition-colors cursor-default border border-slate-700"
                  >
                    {tag}
                    <X
                      size={12}
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-3 pr-10 py-2 text-sm text-white focus:border-blue-500 outline-none transition-all"
                />
