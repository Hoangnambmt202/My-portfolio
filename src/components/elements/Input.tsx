...
export const Input = ({placeholder, label, type, id, htmlFor, value, onChange, error } : {placeholder:string; label:string, type:string, id: string,htmlFor: string, value:string, onChange: (e: React.ChangeEvent<HTMLInputElement>) => void, error:string}) => {
  return (
