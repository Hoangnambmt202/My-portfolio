   ...
   const blogPosts = [
    {
      ...
      excerpt: "Khám phá các kỹ thuật code splitting và lazy loading để cải thiện performance...",
      date: "15 Nov 2025",
      readTime: "5 phút đọc",
      category: "React",
    },
    {
      title: "Microservices Architecture: Best Practices 2025",
      excerpt: "Hướng dẫn chi tiết về cách thiết kế và triển khai microservices hiệu quả...",
      date: "10 Nov 2025",
      readTime: "8 phút đọc",
      category: "Architecture",
    },
    {
      title: "TypeScript Tips & Tricks cho Developer",
      excerpt: "Những mẹo và thủ thuật TypeScript giúp code clean và type-safe hơn...",
      date: "5 Nov 2025",
      readTime: "6 phút đọc",
      category: "TypeScript",
    },
        ...
        >
          {blogPosts.map((post, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors line-clamp-2 h-14">
                {post.title}
              </h3>
              <p className="text-slate-400 mb-4 line-clamp-3 text-sm flex-grow">{post.excerpt}</p>
